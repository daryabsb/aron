...
<template>
  ...
  <div class="min-h-full">
      ...
      <Dialog as="div" class="relative z-40 lg:hidden" @close="sidebarOpen = false">
        ...
        <div class="fixed inset-0 z-40 flex">
          <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
            ...
            <DialogPanel class="relative flex w-full max-w-xs flex-1 flex-col bg-aronium-700 pt-5 pb-4">
              ...
              <nav class="mt-5 h-full flex-shrink-0 divide-y divide-aronium-500 overflow-y-auto" aria-label="Sidebar">
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
      ...
      <div class="flex flex-grow flex-col overflow-y-auto bg-aronium-800 border-r border-aronium-500 pt-5 pb-4">
        <div class="flex flex-shrink-0 items-center px-4">
          <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=cyan&shade=300"
            alt="Easywire logo" />
        </div>
    ...
    <div class="flex flex-1 flex-col lg:pl-64">
      <div class="flex h-16 flex-shrink-0 border-b border-aronium-500 lg:border-none">
        <button type="button"
        ...
        <div class="flex flex-1 justify-between px-4 sm:px-6 lg:mx-auto lg:max-w-6xl lg:px-8">
          <div class="flex flex-1">
            <form class="flex w-full md:ml-0" action="#" method="GET">
              ...
              <div class="relative w-full text-aronium-white focus-within:text-gray-600">
      ...
      <main class="flex-1 pb-8">
              ...
              <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                <div class="min-w-0 flex-1">
                  ...
                  <div v-if="user" class="flex items-center">
                    <img class="hidden h-16 w-16 rounded-full sm:block" :src="user.image" alt="" />
                    <div>
                      <div class="flex items-center">
                        <img class="h-16 w-16 rounded-full sm:hidden" :src="user.image" alt="" />
                        <h1 class="ml-3 text-2xl font-bold leading-7 text-aronium-white sm:truncate sm:leading-9">
                      ...
                      <dl class="mt-6 flex flex-col sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                        ...
                        <dd class="flex items-center text-sm font-medium capitalize text-aronium-white sm:mr-6">
                          <BuildingOfficeIcon class="mr-1.5 h-5 w-5 flex-shrink-0 text-aronium-white"
                            aria-hidden="true" />
                          Duke street studio
                        </dd>
        ...
        <div class="mt-8 overflow-auto scrollbar">
            ...
            <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div v-for="card in cards" :key="card.name"
                ...
                <div class="p-5">
                  <div class="flex items-center">
                    <div class="flex-shrink-0">
                      <component :is="card.icon" class="h-6 w-6 text-aronium-white" aria-hidden="true" />
                    </div>
                    <div class="ml-5 w-0 flex-1">
                      <dl>
                        <dt class="truncate text-sm font-medium text-aronium-white">
                          {{ card.name }}
                        </dt>
                        <dd>
                ...
                <div class="bg-aronium-700 px-5 py-3">
                  <div class="text-sm">
                    <a :href="card.href" class="font-medium text-pink-700 hover:text-pink-500">View all</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <h2 class="mx-auto mt-8 max-w-6xl px-4 text-lg font-medium leading-6 text-aronium-white sm:px-6 lg:px-8">
            Saved orders
          </h2>

          <!-- Activity list (smallest breakpoint only) -->
          <div class="shadow sm:hidden">
            <ul role="list" class="mt-2 divide-y divide-aronium-500 overflow-hidden shadow sm:hidden">
              <li v-for="order in orders" :key="order.id" class="cursor-pointer">
                <!-- :href="order.href" -->
                ...
                <div class="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      <tr v-for="order in orders.filter(o => !o.status).slice(-4)" :key="order.id" class="bg-white">
...
onMounted(loadUnfinishedOrdersData);
const orders = computed(() => store.cart);
