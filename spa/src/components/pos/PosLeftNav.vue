<template>
  ...
  <div class="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
    <div
      class="flex flex-col items-center px-2 py-4 flex-shrink-0 w-full bg-cyan-500 rounded-3xl"
    >
      <a
        href="#"
      ...
      <ul class="flex flex-col space-y-2 mt-12">
        <li>
          <a href="#" class="flex items-center">
            <span
              class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-8 w-8 rounded-2xl mb-2"
              :class="{
                'hover:bg-cyan-400 text-cyan-200': activeMenu !== 'pos',
        ...
        <li>
          <a href="#" class="flex items-center">
            <span
              class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-8 w-8 mb-2 rounded-2xl"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <li>
          <a href="#" class="flex items-center">
            <span
              class="flex items-center justify-center text-cyan-100 hover:bg-cyan-400 h-8 w-8 mb-2 mt-auto rounded-2xl"
            >
              <svg
                class="w-6 h-6"
                fill="none"
      ...
      <a
        ...
        target="_blank"
        class="mt-auto flex items-center justify-center text-cyan-200 hover:text-cyan-100 h-8 w-8 mt-auto focus:outline-none"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-8 w-8"
