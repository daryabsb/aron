  ...
  <div class="flex justify-between w-full h-full items-center">
    ...
    >
      <ul class="flex text-sm mr-3">
        ...
        >
          <div
            class="flex flex-col h-14 xl:h-fit items-center border border-aronium-500 xl:py-1 py-3"
          >
            <!-- @click="broadcastFunction(item)" -->
            <span class="mb-1 text-xl px-6 xl:px-8"
      ...
      <ul class="flex items-center text-sm mr-3">
        ...
        >
          <div
            class="px-1 xl:px-8 flex flex-col items-center border border-aronium-500 py-1"
          >
            <!-- @click="broadcastFunction(item)" -->
            ...
            <span
              class="text-center flex items-center justify-center h-12 xl:h-fit w-16 xl:w-20"
              >Save<span class="hidden xl:block"> &nbsp;sale</span>
            </span>
          </div>
        </li>
        <li
    ...
    <Popper arrow>
      ...
      <template #content="{ close }">
        ...
        >
          <router-link
            v-for="order in store.cart.filter((o) => !o.status)"
...
watchEffect(() => {
  activeNumber.value = store.activeNumber;
});

const togglePaymentModal = () => {
  store.openPaymentModal = true;
};
