    ...
    <TransitionRoot as="template" :show="true">
      <TransitionChild as="template" enter="ease-out duration-2000" enter-from="opacity-0" enter-to="opacity-100"
        ...
        <div class="relative overflow-hidden">
          <main>
            <div class="bg-aronium-500 pt-10 sm:pt-16 lg:overflow-hidden lg:pt-8 lg:pb-14 sm:my-64">
                  ...
                  <div
                    ...
                    <div class="lg:p-24">
                      ...
                      <h1
                        ...
                        @click="addNewOrder">
                        <span class="rounded-sm bg-pink-700 px-3 py-0.5 text-sm font-semibold leading-5 text-white">Keep
                          the changes</span>
                        ...
                        <form action="#" class="sm:mx-auto sm:max-w-xl lg:mx-0">
                          <div class="sm:flex">
                            <div class="min-w-0 flex-1">
                              ...
                              <input id="search-orders" type="text" placeholder="Enter a name or an order number"
                          ...
                          <div class="bg-aronium-800 px-16 overflow-hidden overflow-x-auto shadow sm:rounded-sm mt-3">
                            <table class="divide-y divide-aronium-500">
                              ...
                              <tbody v-if="cart.length > 0" class="divide-y divide-aronium-500 text-aronium-white">
...
const Spinner = defineAsyncComponent(() => import("@/Orders/components/Cards/Spinner.vue"))
