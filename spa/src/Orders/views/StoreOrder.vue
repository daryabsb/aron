<template>
  ...
  <div class="flex h-screen">
    <!-- Narrow sidebar -->
    <div
      class="hidden w-24 overflow-y-auto bg-aronium-800 border-r border-aronium-500 md:block"
    >
                ...
                <div>
                  ...
                  >
                    ...
                    <Suspense>
                      ...
                      <template #fallback>
                        <div
                          class="h-12 w-12 rounded-full bg-aronium-200 border-2 border-aronium-500 animate-pulse"
                        />
                      </template>
                    </Suspense>
                  </MenuButton>
