<template>
  <div class="bg-blue-gray-50" x-data="initApp()" x-init="initDatabase()">
    <nav class="mt-3 mx-4">
      <div class="bg-cyan-500 text-white py-24">
        This is a navbar
      </div>
    </nav>
    <!-- noprint-area -->
    ...
    >
      ...
      <div class="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
        <div
          class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500"
        >
          <a
            href="#"
        ...
        <div class="flex flex-col bg-blue-gray-50 h-full w-full py-4">
          ...
          <div class="h-full overflow-hidden mt-4">
            <div class="h-full overflow-y-auto px-2">
              ...
              >
                <div x-for="product in filteredProducts()" :key="product.id">
                  <div
                    role="button"
          ...
          >
            ...
            <div>
              <table class="w-full text-xs">
                ...
                <tbody>
                  <div x-for="(item, index) in cart" :key="item">
                    <tr>
