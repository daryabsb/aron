...
-->
<template>
  <div class="bg-aronium-800 text-aronium-white h-screen">
    <Popover as="header" class="relative">
      <div class="border border-aronium-500">
        <nav
          class="relative mx-auto flex max-w-full items-center justify-between px-6 pt-6 xl:px-8 py-6 mb-3"
          aria-label="Global"
        >
        ...
        >
          ...
          >
            <div class="flex items-center justify-between px-5 pt-4">
              ...
              <div class="-mr-2">
                <PopoverButton
                  class="inline-flex items-center justify-center rounded-md bg-aronium-900 p-2 text-aronium-white hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500"
                >
