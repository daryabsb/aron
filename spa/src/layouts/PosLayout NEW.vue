<template>
  ...
  <div class="flex h-full flex-col">
    ...
    <div class="flex min-h-0 flex-1 overflow-hidden">
      ...
      <!-- Main area -->
      <main class="min-w-0 flex-1 border-t border-gray-200 flex">
        <!-- Message list-->
        <aside class="order-first block flex-shrink-0">
          STORE ORDER
          <div
            class="relative flex w-full sm:w-96 flex-col border-r border-gray-200 bg-gray-100"
          >
            <div class="flex-shrink-0">
            ...
            >
              ...
              <!-- <ul
                role="list"
                class="h-[40em] overflow-auto divide-y divide-gray-200 border-b border-gray-200"
              >
                <li
            ...
            <div>
              <span class="fixed">END OF ORDER</span>
            </div>
          </div>
        </aside>
        <section
          aria-labelledby="message-heading"
          class="block sm:flex h-full min-w-0 flex-1 flex-col overflow-hidden xl:order-last"
        >
          <!-- Top section -->
          ...
          <div class="min-h-0 flex-1 overflow-y-auto">
            ...
            <ul
              role="list"
              class="flex flex-wrap gap-4 justify-start items-start py-4 sm:px-6 lg:px-8"
            >
              <!-- <li>STORE MENU</li> -->
              <li
                v-for="item in message.items"
                :key="item.id"
                class="bg-aronium-900 h-36 w-48 text-aronium-white px-4 py-6 shadow sm:rounded-sm sm:px-6"
              >
                <div
                  class="sm:flex sm:flex-wrap sm:items-baseline sm:justify-between"
                >
                  <h3 class="text-base font-medium">
                    <span class="">{{ item.author }}</span>
                  </h3>
                  <p
                    class="mt-1 whitespace-nowrap text-sm text-gray-50 sm:mt-0 sm:ml-3"
                  >
